...
export class AuthorService {
  ...
  crateUrl: string = "http://54.212.211.121:9090/api/v1/author/";
  updateUrl : string = "http://54.212.211.121:9090/api/v1/author/";
  authenticateUrl: string = "http://54.212.211.121:9090/api/v1/author/authenticate";
  signUpUrl : string = "http://54.212.211.121:9090/api/v1/author/signup";
